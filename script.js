...
class PessoaJuridica extends Cliente {
    constructor(idCliente, tipoCliente, dataCriacao, codBanco, agencia, conta, saldo, nomeFantasia, cnpj, email, telefone, dataDaFantasia) {
        super(...arguments)
        this.nomeFantasia = nomeFantasia
        this.cnpj = cnpj
        this.email = email
        this.telefone = telefone
        this.dataDaFantasia = dataDaFantasia
    }
}
...
class Transacao {
    static transferencia(contaOrigem, contaDestino, idTransacao, dataDeTransacao, valorDaTransferencia) {
        ...
        return { mensagem: "Saldo insuficiente para transaferência!" }
    }
